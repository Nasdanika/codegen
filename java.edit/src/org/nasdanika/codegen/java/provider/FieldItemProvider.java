...
/**
 * This is the item provider adapter for a {@link org.nasdanika.codegen.java.Field} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FieldItemProvider extends MemberItemProvider {
	...
	public String getText(Object object) {
		...
		if (Util.isBlank(label)) {
			label = ((Field)object).getName();
		}
		return label == null || label.length() == 0 ? getString("_UI_Field_type") : label;
	}
