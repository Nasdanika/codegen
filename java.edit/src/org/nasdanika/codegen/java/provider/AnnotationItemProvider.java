...
/**
 * This is the item provider adapter for a {@link org.nasdanika.codegen.java.Annotation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AnnotationItemProvider extends TypeItemProvider {
	...
	public String getText(Object object) {
		...
		if (Util.isBlank(label)) {
			label = ((Annotation)object).getName();
		}		
		return label == null || label.length() == 0 ? getString("_UI_Annotation_type") : label;
	}
