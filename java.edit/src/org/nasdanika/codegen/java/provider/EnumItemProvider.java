...
public class EnumItemProvider extends TypeItemProvider {
	...
	public String getText(Object object) {
		String label = ((org.nasdanika.codegen.java.Enum)object).getTitle();
		if (Util.isBlank(label)) {
			label = ((org.nasdanika.codegen.java.Enum)object).getName();
		}
		return label == null || label.length() == 0 ? getString("_UI_Enum_type") : label;
	}
