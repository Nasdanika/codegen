...
/**
 * This is the item provider adapter for a {@link org.nasdanika.codegen.java.Constructor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConstructorItemProvider extends OperationItemProvider {
	...
	public String getText(Object object) {
		String label = ((Constructor)object).getTitle();
		if (Util.isBlank(label)) {
			label = ((Constructor)object).getName();
		}
		return label == null || label.length() == 0 ? getString("_UI_Constructor_type") : label;
	}
