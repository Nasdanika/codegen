...
/**
 * This is the item provider adapter for a {@link org.nasdanika.codegen.java.PluginNature} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PluginNatureItemProvider extends NatureItemProvider {
	/**
	 ...
	 * @generated
	 */
	public PluginNatureItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(JavaPackage.Literals.PLUGIN_NATURE__MANIFEST_GENERATOR);
			childrenFeatures.add(JavaPackage.Literals.PLUGIN_NATURE__BUILD_PROPERTIES_GENERATOR);
			childrenFeatures.add(JavaPackage.Literals.PLUGIN_NATURE__PLUGIN_XML_GENERATOR);
			childrenFeatures.add(JavaPackage.Literals.PLUGIN_NATURE__FRAGMENT_XML_GENERATOR);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/PluginNature"));
	}
	...
	public String getText(Object object) {
		String label = ((PluginNature)object).getBaseURL();
		return label == null || label.length() == 0 ?
			getString("_UI_PluginNature_type") :
			getString("_UI_PluginNature_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(PluginNature.class)) {
			case JavaPackage.PLUGIN_NATURE__MANIFEST_GENERATOR:
			case JavaPackage.PLUGIN_NATURE__BUILD_PROPERTIES_GENERATOR:
			case JavaPackage.PLUGIN_NATURE__PLUGIN_XML_GENERATOR:
			case JavaPackage.PLUGIN_NATURE__FRAGMENT_XML_GENERATOR:
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == JavaPackage.Literals.PLUGIN_NATURE__MANIFEST_GENERATOR ||
			childFeature == JavaPackage.Literals.PLUGIN_NATURE__BUILD_PROPERTIES_GENERATOR ||
			childFeature == JavaPackage.Literals.PLUGIN_NATURE__PLUGIN_XML_GENERATOR ||
			childFeature == JavaPackage.Literals.PLUGIN_NATURE__FRAGMENT_XML_GENERATOR;
