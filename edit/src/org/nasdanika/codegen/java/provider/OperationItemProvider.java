...
public class OperationItemProvider extends MemberItemProvider {
	...
	protected void addThrownExceptionsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Operation_thrownExceptions_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Operation_thrownExceptions_feature", "_UI_Operation_type"),
				 JavaPackage.Literals.OPERATION__THROWN_EXCEPTIONS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Operation.class)) {
			...
			case JavaPackage.OPERATION__THROWN_EXCEPTIONS:
