...
public class TextFileItemProvider extends FileItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TextFile_encoding_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TextFile_encoding_feature", "_UI_TextFile_type"),
				 CodegenPackage.Literals.TEXT_FILE__ENCODING,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((TextFile)object).getTitle();
		if (isBlank(label)) {
			label = ((TextFile)object).getName();
		}
		return isBlank(label) ?	getString("_UI_TextFile_type") : label;
	}
