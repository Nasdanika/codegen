 ...
 * @generated
 */
public class PropertyItemProvider extends AbstractNamedGeneratorItemProvider {
	/**
	...
	protected void addInterpolatePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Property_interpolate_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Property_interpolate_feature", "_UI_Property_type"),
				 CodegenPackage.Literals.PROPERTY__INTERPOLATE,
				 true,
				 false,
				 false,
