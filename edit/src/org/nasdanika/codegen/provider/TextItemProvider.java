...
/**
 * This is the item provider adapter for a {@link org.nasdanika.codegen.Text} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TextItemProvider extends GeneratorItemProvider {
	/**
	...
	protected void addTextPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor(
				 ...
				 CodegenPackage.Literals.TEXT__TEXT,
				 true,
				 true,
				 false,
	...
	protected void addInterpolatePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor(
				 getResourceLocator(),
				 getString("_UI_Text_interpolate_feature"),
				 CodegenPackage.Literals.TEXT__INTERPOLATE,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Text.class)) {
			case CodegenPackage.TEXT__TEXT:
			case CodegenPackage.TEXT__INTERPOLATE:
