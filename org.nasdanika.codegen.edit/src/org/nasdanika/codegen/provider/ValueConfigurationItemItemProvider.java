...
/**
 * This is the item provider adapter for a {@link org.nasdanika.codegen.ValueConfigurationItem} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ValueConfigurationItemItemProvider extends ConfigurationItemItemProvider {
	/**
	 ...
	 * @generated
	 */
	public ValueConfigurationItemItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ValueConfigurationItem_valueType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ValueConfigurationItem_valueType_feature", "_UI_ValueConfigurationItem_type"),
				 CodegenPackage.Literals.VALUE_CONFIGURATION_ITEM__VALUE_TYPE,
				 true,
				 false,
				 false,
	...
	protected void addDefaultPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ValueConfigurationItem_default_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ValueConfigurationItem_default_feature", "_UI_ValueConfigurationItem_type"),
				 CodegenPackage.Literals.VALUE_CONFIGURATION_ITEM__DEFAULT,
				 true,
				 false,
				 false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ValueConfigurationItem"));
	}
	...
	public String getText(Object object) {
		String label = ((ValueConfigurationItem)object).getBaseURL();
		return label == null || label.length() == 0 ?
			getString("_UI_ValueConfigurationItem_type") :
			getString("_UI_ValueConfigurationItem_type") + " " + label;
	}
