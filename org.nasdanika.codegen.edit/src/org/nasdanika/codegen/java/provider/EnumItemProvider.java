...
public class EnumItemProvider extends TypeItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Enum_superInterfaces_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Enum_superInterfaces_feature", "_UI_Enum_type"),
				 JavaPackage.Literals.ENUM__SUPER_INTERFACES,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((org.nasdanika.codegen.java.Enum)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(org.nasdanika.codegen.java.Enum.class)) {
			case JavaPackage.ENUM__SUPER_INTERFACES:
