...
public class WizardSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case WizardPackage.WIZARD_PAGE_CONTENT: {
				WizardPageContent wizardPageContent = (WizardPageContent)theEObject;
				T result = caseWizardPageContent(wizardPageContent);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseWizardPageContent(WizardPageContent object) {
		return null;
	}
