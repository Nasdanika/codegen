...
public class WizardAdapterFactory extends AdapterFactoryImpl {
	...
	protected WizardSwitch<Adapter> modelSwitch =
		new WizardSwitch<Adapter>() {
			...
			@Override
			public Adapter caseWizardPageContent(WizardPageContent object) {
				return createWizardPageContentAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.nasdanika.codegen.wizard.Wizard <em>Wizard</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.nasdanika.codegen.wizard.WizardPage <em>Page</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.nasdanika.codegen.wizard.WizardPageContent <em>Page Content</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createWizardPageContentAdapter() {
		return null;
	}
